...
import FriendsRequestsList from '../Lists/FriendsRequestsList';
        ...
        >
            <DialogBody>
                <Tabs value={value} onChange={handleChange}>
                    ...
                    <TabsBody>
                        <TabPanel value={0} className='max-h-[456px] overflow-auto'>
                            <UsersList />
                        </TabPanel>
                        <TabPanel value={1} className='max-h-[456px] overflow-auto'>
                            <FriendsList />
                        </TabPanel>
                        <TabPanel value={2} className='max-h-[456px] overflow-auto'>
                            <FriendsRequestsList />
                        </TabPanel>
                    </TabsBody>
                </Tabs>
