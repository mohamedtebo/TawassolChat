...
const ModalTheme = ({openTheme, handleOpenTheme}) => {
    ...
    return (
        ...
        >
            <DialogHeader className='text-textBlack text-[15px] sm:text-[18px] md:text-[21px]'>Choose theme</DialogHeader>
            ...
            <DialogFooter className='flex gap-3 items-center'>
                <Typography className='cursor-pointer text-textBlack text-[10px] sm:text-[12px] md:text-[14px]' onClick={handleOpenTheme}>Cancel</Typography>
                <Button variant="gradient" color="purple" className='p-3 text-[10px] sm:text-[12px] md:text-[14px] focus:outline-none'>
                    <span>Confirm</span>
                </Button>
            </DialogFooter>
        </Dialog>
